frappe.pages['packing'].on_page_load = function(wrapper) {
	...
	function render_orders(order) {
		...
		frappe.call({
			method: 'masar_miraaya_new.masar_miraaya_new.page.packing.packing.get_confirmed_sales_orders',
			args: {
				so: order
			},
			callback: function(r) {
	...
	function open_pick_list(sales_order) {
		frappe.call({
			method: 'masar_miraaya_new.masar_miraaya_new.page.packing.packing.get_picklist_from_so',
			args: {
				so: sales_order
			},
			callback: function(r) {
